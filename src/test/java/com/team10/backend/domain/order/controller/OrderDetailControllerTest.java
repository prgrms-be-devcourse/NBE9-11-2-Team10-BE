...
public class OrderDetailControllerTest {
    ...
    void getOrderDetail_Buyer_Success() throws Exception {
        ...
        // 구매자(1), 상품(101), 주문(501)
        jdbcTemplate.update("INSERT INTO orders (id, user_id, order_number, total_amount, created_at) VALUES (501, 1, ?, 10000, CURRENT_TIMESTAMP)", orderNum);
    ...
    void getOrderDetail_Seller_Success() throws Exception {
        ...
        jdbcTemplate.update("INSERT INTO orders (id, user_id, order_number, total_amount, created_at) VALUES (502, 20, ?, 10000, CURRENT_TIMESTAMP)", orderNum);
    ...
    void getOrderDetail_Buyer_AccessDenied() throws Exception {
        ...
        jdbcTemplate.update("INSERT INTO orders (id, user_id, order_number, total_amount, created_at) VALUES (501, 1, 'ORD-DETAIL-001', 10000, CURRENT_TIMESTAMP)");
